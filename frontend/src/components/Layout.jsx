...
export default function Layout() {
  ...
  const renderNavItem = (item) => (
    <NavLink
      ...
      className={({ isActive }) =>
        [
          'group flex items-center justify-between rounded-xl px-4 py-2.5 text-sm font-medium transition',
          isActive
  ...
  return (
    <div className="min-h-screen bg-transparent">
      <div className="mx-auto flex min-h-screen w-full max-w-[1720px] gap-6 p-4 lg:p-6">
        <aside className="hidden w-72 shrink-0 flex-col rounded-xl border bg-card px-5 py-6 text-card-foreground shadow-card lg:flex">
              ...
              return (
                <div key={group.label}>
                  <button
                    ...
                    className="flex w-full items-center justify-between rounded-xl px-4 py-2.5 text-sm font-semibold text-muted-foreground/70 transition hover:bg-accent hover:text-accent-foreground"
                  >
                    {group.label}
                    <ChevronDown
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-6">
          <header className="rounded-xl border bg-card/70 px-5 py-4 shadow-card backdrop-blur-sm lg:px-6">
          ...
          <main className="flex-1 rounded-xl border bg-card/70 p-4 shadow-card backdrop-blur-sm sm:p-6 lg:p-8">
            <Outlet />
          </main>
        </div>
      </div>
